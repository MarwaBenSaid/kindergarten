...
public class RestControllerUser  {
    ...
    @ResponseBody
	public String verify( User s,@RequestParam String Code )
	{
    ...
    @ResponseBody
	public boolean isverify( User s) {
    ...
    @ResponseBody
	public String Change(@RequestParam int number,@RequestParam String password,@RequestParam int idu)
    {
		String x=iuserservice.UpdateRestPassword(number,password,idu);
		return x;
	}
