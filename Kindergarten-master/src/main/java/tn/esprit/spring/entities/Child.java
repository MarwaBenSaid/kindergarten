...
public class Child  implements Serializable {
	...
	private Boolean transportInscrip ;
    @ManyToOne
	...
	public Boolean getTransportInscrip() {
		return transportInscrip;
	}

	public void setTransportInscrip(Boolean transportInscrip) {
		this.transportInscrip = transportInscrip;
	}
